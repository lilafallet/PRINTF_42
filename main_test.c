...
int	main(void)
{
	...
	printf("%d %hd %d", 7, 7, 7);
	printf("\n"); //SAUT DE LIGNE
	printf("\033[32;01m%d %hd %d\033[00m", 7, 7, 7); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 43\033[00m\n"); //NUMERO
	printf("%000012x", 3735928559U);
	printf("\n"); //SAUT DE LIGNE
	printf("\033[32;01m%000012x\033[00m", 3735928559U); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 44\033[00m\n"); //NUMERO
  	printf("-%3d-%3d-%3d-", -1, -12, -123);
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m-%3d-%3d-%3d\033[00m-", -1, -12, -123); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 45\033[00m\n"); //NUMERO
  	printf("\033[32;01m-%.3d-%.3d-%.3d-", 12, 123, 1234);
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m-%.3d-%.3d-%.3d\033[00m-", 12, 123, 1234); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 46\033[00m\n"); //NUMERO
 	printf("-%08.0d-", 0);
	printf("\n"); //SAUT DE LIGNE
 	printf("\033[32;01m-%08.0d\033[00m-", 0); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 47\033[00m\n"); //NUMERO
  	printf("-%2.0d-\n", 7);
  	printf("\033[32;01m-%2.0d\033[00m-\n", 7); //MYPRINTF
	...
	printf("\n"); //SAUT DE LIGNE
	printf("\033[32;01m-%d-%.0d-%.8d-%8.0d-%8.8d\033[00m-", 0, 0, 0, 0, 0); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 51\033[00m\n"); //NUMERO
  	printf("%.3d %.-3d", 21, 21);
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m%.3d %.-3d\033[00m", 21, 21); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 52\033[00m\n"); //NUMERO
 	printf("%-*d", 10, 1234);
	printf("\n"); //SAUT DE LIGNE
 	printf("\033[32;01m\033[32;01m%-*d\033[00m", 10, 1234); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 53\033[00m\n"); //NUMERO
  	printf("%*d",  10, 1234);
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m%*d\033[00m",  10, 1234); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 54\033[00m\n"); //NUMERO
	printf("%08x", 543);
	printf("\n"); //SAUT DE LIGNE
	printf("\033[32;01m%08x\033[00m", 543); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 55\033[00m\n"); //NUMERO
 	printf("%x", 0x12345);	
	printf("\n"); //SAUT DE LIGNE
 	printf("\033[32;01m%x\033[00m", 0x12345); //MYPRINTF	
	printf("\n"); //SAUT DE LIGNE
	...
	printf("\n"); //SAUT DE LIGNE
	printf("\033[32;01m%d %d %d\033[00m", 0, 42, 2147483647); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	...
	printf("\n"); //SAUT DE LIGNE
	printf("\033[32;01m%d %d %d %d %d %d %d %d %d %d %d %d\033[00m", 1, 2, 3, 4, 5, 6, 7, 8, 9, 0xA, 0xB, 0xC); //MYPRINTF	
	printf("\n"); //SAUT DE LIGNE
	...
	printf("\033[31;01mNUMERO 1\033[00m\n"); //NUMERO
	printf("some text\n");
	printf("\033[32;01msome text\033[00m\n"); //MYPRINTF
	printf("\033[31;01mNUMERO 2\033[00m\n"); //NUMERO
  	printf("abcdefghijklmnopqrstuvwxyz0123\n");
  	printf("\033[32;01mabcdefghijklmnopqrstuvwxyz0123\033[00m\n"); //MYPRINTF
	printf("\033[31;01mNUMERO 3\033[00m\n"); //NUMERO
  	printf("abcdefghijklmnopqrstuvwxyz01234\n");
  	printf("\033[32;01mabcdefghijklmnopqrstuvwxyz01234\033[00m\n"); //MYPRINTF
	printf("\033[31;01mNUMERO 4\033[00m\n"); //NUMERO
  	printf("abcdefghijklmnopqrstuvwxyz012345\n");
  	printf("\033[32;01mabcdefghijklmnopqrstuvwxyz012345\033[00m\n"); //MYPRINTF
	printf("\033[31;01mNUMERO 5\033[00m\n"); //NUMERO
	printf("%s\n", "");
	...
	printf("%10s", "Salut");
	printf("\n"); //SAUT DE LIGNE
	printf("\033[32;01m%10s\033[00m", "Salut"); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 8\033[00m\n"); //NUMERO
  	printf("%10s", "Salut tout le monde");
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m%10s\033[00m", "Salut tout le monde"); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 9\033[00m\n"); //NUMERO
  	printf("%10.10s", "Salut tout le monde");
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m%10.10s\033[00m", "Salut tout le monde");//MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	...
	printf("\033[31;01mNUMERO 1\033[00m\n"); //NUMERO
	printf("-%4d-%-4d-%4d-\n", 7, 54, 12345);
	printf("\033[32;01m-%4d-%-4d-%4d\033[00m-\n", 7, 54, 12345); //MYPRINTF
	printf("\033[31;01mNUMERO 2\033[00m\n"); //NUMERO
  	printf("-%4s-%4s-\n", "A", "ABCDEF");
  	printf("\033[32;01m-%4s-%4s\033[00m-\n", "A", "ABCDEF"); //MYPRINTF
	printf("\033[31;01mNUMERO 3\033[00m\n"); //NUMERO
  	printf("-%-4d-\n", 7);
  	printf("\033[32;01m-%-4d\033[00m-\n", 7); //MYPRINTF
	printf("\033[31;01mNUMERO 4\033[00m\n"); //NUMERO
  	printf("-%4p-\n", main);
  	printf("\033[32;01m-%4p\033[00m-\n", main); //MYPRINTF
	printf("\033[31;01mNUMERO 5\033[00m\n"); //NUMERO
  	printf("-%*d-\n", 4, 7);
  	printf("\033[32;01m-%*d\033[00m-\n", 4, 7); //MYPRINTF
	printf("\033[31;01mNUMERO 6\033[00m\n"); //NUMERO
	...
	printf("\033[31;01mNUMERO 8\033[00m\n"); //NUMERO
  	printf("-%3c-%-3c-\n", 'a', 'b');
  	printf("\033[32;01m-%3c-%-3c\033[00m-\n", 'a', 'b'); //MYPRINTF
	printf("\033[31;01mNUMERO 9\033[00m\n"); //NUMERO
  	printf("-%3s-%-3s-\n", "A", "B");
  	printf("\033[32;01m-%3s-%-3s\033[00m-\n", "A", "B"); //MYPRINTF
	printf("\033[31;01mNUMERO 10\033[00m\n"); //NUMERO
  	printf("-%.4d-%.4d-%.d-%.0d-\n", 7, 12345, 1, 9);
  	printf("\033[32;01m-%.4d-%.4d-%.d-%.0d\033[00m-\n", 7, 12345, 1, 9); //MYPRINTF
	printf("\033[31;01mNUMERO 11\033[00m\n"); //NUMERO
  	printf("-%.4s-%.4s-%.s-\n", "A", "ABCDEF", "ABC");
  	printf("\033[32;01m-%.4s-%.4s-%.s\033[00m-\n", "A", "ABCDEF", "ABC"); //MYPRINTF
	printf("\033[31;01mNUMERO 12\033[00m\n"); //NUMERO
  	printf("-%.*d-\n", 4, 7);
  	printf("\033[32;01m-%.*d\033[00m-\n", 4, 7); //MYPRINTF
	printf("\033[31;01mNUMERO 13\033[00m\n"); //NUMERO
	...
	printf("\033[31;01mNUMERO 14\033[00m\n"); //NUMERO
  	...
  	printf("\033[32;01m%.1d %.0d %.1u %.0u %.1o %.0o %.1x %.0x\033[00m\n", 0, 0, 0, 0, 0, 0, 0, 0); //MYPRINTF
	printf("\033[31;01mNUMERO 15\033[00m\n"); //NUMERO
  	printf("%.5d\n", -17);
  	printf("\033[32;01m%.5d\033[00m\n", -17); //MYPRINTF
	printf("\033[31;01mNUMERO 16\033[00m\n"); //NUMERO
  	printf("-%6.4d-%4.6d-\n", 12345, 12345);
  	printf("\033[32;01m-%6.4d-%4.6d\033[00m-\n", 12345, 12345); //MYPRINTF
	printf("\033[31;01mNUMERO 17\033[00m\n"); //NUMERO
  	printf("-%*.*d-%*.*d-\n", 6, 4, 12345, 4, 6, 12345);
	...
	printf("\033[31;01mNUMERO 19\033[00m\n"); //NUMERO
  	printf("-%6.4s-%4.6s-\n", "ABCDE", "ABCDE");
  	printf("\033[32;01m-%6.4s-%4.6s\033[00m-\n", "ABCDE", "ABCDE"); //MYPRINTF
	...
	printf("\n"); //SAUT DE LIGNE
	printf("\033[32;01m%c %d %s\033[00m", 42, 42, str); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 2\033[00m\n"); //NUMERO
	printf("%X %p %d", 0x12345, str, 42);
	printf("\n"); //SAUT DE LIGNE
	printf("\033[32;01m%X %p %d\033[00m", 0x12345, str, 42); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	...
	printf("\033[31;01mNUMERO 1\033[00m\n"); //NUMERO
 	printf("-%.4p-", main);
	printf("\n"); //SAUT DE LIGNE
 	printf("\033[32;01m-%.4p\033[00m-", main); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 2\033[00m\n"); //NUMERO
  	printf("-%.-4d-", 7);
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m-%.-4d-\033[00m", 7); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 3\033[00m\n"); //NUMERO
  	printf("%#s %0s", "ABC", "ABC");
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m%#s %0s\033[00m", "ABC", "ABC"); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 4\033[00m\n"); //NUMERO
  	printf("-%%-%-%-%0%-%1%-%2%-%.2%-%.%-%-2%-");
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m-%%-%-%-%0%-%1%-%2%-%.2%-%.%-%-2%\033[00m-"); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 5\033[00m\n"); //NUMERO
  	printf("%k", 7);
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m%k\033[00m", 7); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 6\033[00m\n"); //NUMERO
  	printf("%02k", 7);
	printf("\n"); //SAUT DE LIGNE
	...
	printf("%?d", 7);
	printf("\n"); //SAUT DE LIGNE
	printf("\033[32;01m%?d\033[00m", 7); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 9\033[00m\n"); //NUMERO
  	printf("%2*d", 4, 7);
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m%2*d\033[00m", 4, 7); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 10\033[00m\n"); //NUMERO
  	printf("%.0*d", 4, 7);
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m%.0*d\033[00m", 4, 7); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 11\033[00m\n"); //NUMERO
  	printf("%*2d", 4, 7);
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m%*2d\033[00m", 4, 7); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 12\033[00m\n"); //NUMERO
  	printf("%.*2d", 4, 7);
	printf("\n"); //SAUT DE LIGNE
	...
	printf("%16k");
	printf("\n"); //SAUT DE LIGNE
	printf("\033[32;01m%16k\033[00m"); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 15\033[00m\n"); //NUMERO
  	printf("%0k %0.1k");
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m%0k %0.1k\033[00m"); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 16\033[00m\n"); //NUMERO
  	printf("%%d", 17);
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m%%d\033[00m", 17); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 17\033[00m\n"); //NUMERO
  	printf("%%%d", 17);
	printf("\n"); //SAUT DE LIGNE
	...
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m%*.*k %0*.*k\033[00m", 0, 0, 0, 0); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 19\033[00m\n"); //NUMERO
  	printf("%.2p", main);
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m%.2p\033[00m", main); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 20\033[00m\n"); //NUMERO
  	printf("%.12p", main);
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m%.12p\033[00m", main); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 21\033[00m\n"); //NUMERO
  	printf("%2p", main);
	printf("\n"); //SAUT DE LIGNE
	...
	printf("\033[31;01mNUMERO 23\033[00m\n"); //NUMERO
  	printf("%012p", main);
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m%012p\033[00m", main); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 24\033[00m\n"); //NUMERO
  	printf("% 12p", main);
	printf("\n"); //SAUT DE LIGNE
	...
	printf("\033[31;01mNUMERO 26\033[00m\n"); //NUMERO
  	printf("%.2p", NULL);
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m%.2p\033[00m", NULL); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 27\033[00m\n"); //NUMERO
  	printf("%.12p", NULL);
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m%.12p\033[00m", NULL); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 28\033[00m\n"); //NUMERO
  	printf("%2p", NULL);
	printf("\n"); //SAUT DE LIGNE
	...
	printf("\033[31;01mNUMERO 30\033[00m\n"); //NUMERO
  	printf("%012p", NULL);
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m%012p\033[00m", NULL); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 31\033[00m\n"); //NUMERO
  	printf("% 12p", NULL);
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m% 12p", NULL); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 32\033[00m\n"); //NUMERO
  	printf("%-12p", NULL);
	printf("\n"); //SAUT DE LIGNE
	...
	printf("%2s", NULL);
	printf("\n"); //SAUT DE LIGNE
	printf("\033[32;01m%2s\033[00m", NULL); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 34\033[00m\n"); //NUMERO
  	printf("%10s", NULL);
	printf("\n"); //SAUT DE LIGNE
  	printf("\033[32;01m%10s\033[00m", NULL); //MYPRINTF
	printf("\n"); //SAUT DE LIGNE
	printf("\033[31;01mNUMERO 35\033[00m\n"); //NUMERO
  	printf("%.5s", NULL);
	printf("\n"); //SAUT DE LIGNE
